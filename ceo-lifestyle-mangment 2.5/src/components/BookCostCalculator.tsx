...
export default function BookCostCalculator({ settings, inventory }: BookCostCalculatorProps) {
  ...
  }, [books, exchangeRate, shippingCost, deliveryMethodId, selectedParish, targetDestination, isOverride, discountPercent, additionalCharges]);
  ...
  return (
    <div className="bg-white border border-slate-200/60 rounded-2xl p-4 shadow-sm space-y-3.5 text-left animate-fade-in relative" id="book-cost-calculator-widget" ref={searchDropdownRef}>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-3 border-t border-slate-100">
        ...
        {/* Target Destination (Immediately below Delivery Method) */}
        <div className="space-y-1.5">
          ...
          <input
            ...
            placeholder="e.g. Montego Bay, Kingston, Ocho Rios..."
          ...
          <div className="flex flex-wrap gap-1 pt-0.5">
            {["Montego Bay", "Kingston", "Ocho Rios", "Fresh Drip Outlet", "Customer Pickup", "St. Elizabeth"].map((dest) => (
              <button
                key={dest}
                type="button"
