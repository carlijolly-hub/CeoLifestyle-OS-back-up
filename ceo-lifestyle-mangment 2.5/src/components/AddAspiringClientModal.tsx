...
export default function AddAspiringClientModal({
  ...
  return (
    <div className="fixed inset-0 bg-slate-950/60 backdrop-blur-sm z-50 flex items-center justify-center p-3 sm:p-4 animate-fade-in">
      <div 
        className="bg-white border border-slate-200/80 rounded-[2rem] sm:rounded-3xl max-w-xl w-full p-5 sm:p-6 space-y-4 shadow-2xl relative max-h-[92vh] overflow-y-auto text-left transition-all"
