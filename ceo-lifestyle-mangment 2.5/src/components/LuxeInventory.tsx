...
export default function LuxeInventory({ inventory, onUpdateInventory, settings }: LuxeInventoryProps) {
  ...
  return (
    <div className="space-y-6 text-left animate-fade-in">
      ...
      {(currentCarouselIndex === 2 || currentCarouselIndex === 3) && (
        ...
        {showAddForm && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/70 backdrop-blur-md animate-fade-in">
            <form onSubmit={handleAddItem} className="bg-white border border-slate-200/80 rounded-3xl max-w-2xl w-full p-6 space-y-4 shadow-2xl relative max-h-[90vh] overflow-y-auto text-left">
      ...
      {editingItem && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/70 backdrop-blur-md animate-fade-in">
          <form onSubmit={handleSaveFullEdit} className="bg-white border border-slate-200/80 rounded-3xl max-w-2xl w-full p-6 space-y-4 shadow-2xl relative max-h-[90vh] overflow-y-auto text-left">
