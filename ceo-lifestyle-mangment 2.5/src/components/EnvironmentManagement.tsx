...
export default function EnvironmentManagement({ 
  ...
  const isAnyModalOpen = !!(showSwitchModal || showResetModal || showLiveImportWarning || importResult);
    ...
    <div className="space-y-8 text-left max-w-5xl">
        ...
        {importResult && (
          <div className="bg-emerald-500/10 border border-emerald-500/40 rounded-2xl p-4 text-emerald-300 text-xs flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span>Successfully imported environment dataset ({importResult.details.clientsAdded} clients, {importResult.details.quotationsAdded} quotations restored).</span>
            </div>
            <button
              type="button"
      ...
      {showSwitchModal && (
        <div className="fixed inset-0 z-50 bg-slate-950/80 backdrop-blur-xs flex items-center justify-center p-4 text-left">
          <div className="bg-slate-900 border border-slate-800 rounded-3xl max-w-md w-full p-6 text-white space-y-5 shadow-2xl animate-in fade-in zoom-in-95 duration-150">
      ...
      {showLiveImportWarning && (
        <div className="fixed inset-0 z-50 bg-slate-950/85 backdrop-blur-xs flex items-center justify-center p-4 text-left">
          <div className="bg-slate-900 border-2 border-amber-500/50 rounded-3xl max-w-md w-full p-6 text-white space-y-5 shadow-2xl animate-in fade-in zoom-in-95 duration-150">
