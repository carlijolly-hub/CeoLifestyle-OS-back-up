    ...
    <div className="space-y-4 text-left animate-fade-in" id="production-tools-module">
      ...
      {selectedQuoteForModal && (
        <div className="fixed inset-0 z-50 bg-slate-900/75 backdrop-blur-xs flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-slate-900 border border-slate-800 text-white rounded-3xl max-w-2xl w-full shadow-2xl p-6 space-y-5 animate-in fade-in zoom-in duration-150 text-left">
      ...
      {maxFavoritesModalOpen && (
        <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-slate-900 border border-amber-500/50 rounded-2xl p-6 max-w-sm w-full space-y-4 text-left shadow-2xl animate-in fade-in zoom-in-95">
